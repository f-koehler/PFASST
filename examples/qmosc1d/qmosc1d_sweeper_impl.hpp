...
namespace pfasst
{
  namespace examples
  {
    namespace qmosc1d
    {
      ...
      void
      QmOsc1d<SweeperTrait, Enabled>::init_opts()
      {
      ...
      template<class SweeperTrait, typename Enabled>
      QmOsc1d<SweeperTrait, Enabled>::QmOsc1d(const size_t& ndofs, const typename SweeperTrait::time_type& epsilon)
      ...
      template<class SweeperTrait, typename Enabled>
      void
      QmOsc1d<SweeperTrait, Enabled>::set_options()
      {
        IMEX<SweeperTrait, Enabled>::set_options();

        this->_epsilon = config::get_value<typename traits::spatial_type>("epsilon", DEFAULT_EPSILON);
      }

      template<class SweeperTrait, typename Enabled>
      shared_ptr<typename SweeperTrait::encap_type>
      QmOsc1d<SweeperTrait, Enabled>::exact(const typename SweeperTrait::time_type& t)
      {
        ...
        auto result = this->get_encap_factory().create();
        double x = 1., f = pow(boost::math::constants::pi<double>(), 0.25)/sqrt(2.);
        for(size_t i = 0; i < this->get_num_dofs(); ++i) {
            result->data()[i] += f*boost::math::hermite<double>(1, x)*exp(-x*x/2.);
        }
      ...
      template<class SweeperTrait, typename Enabled>
      void
      QmOsc1d<SweeperTrait, Enabled>::post_step()
      {
      ...
      template<class SweeperTrait, typename Enabled>
      bool
      QmOsc1d<SweeperTrait, Enabled>::converged()
      {
      ...
      template<class SweeperTrait, typename Enabled>
      size_t
      QmOsc1d<SweeperTrait, Enabled>::get_num_dofs() const
      {
      ...
      QmOsc1d<SweeperTrait, Enabled>::compute_error(const typename SweeperTrait::time_type& t)
      {
      ...
      template<class SweeperTrait, typename Enabled>
      vector<shared_ptr<typename SweeperTrait::encap_type>>
      QmOsc1d<SweeperTrait, Enabled>::compute_relative_error(const vector<shared_ptr<typename SweeperTrait::encap_type>>& error,
      ...
      template<class SweeperTrait, typename Enabled>
      shared_ptr<typename SweeperTrait::encap_type>
      QmOsc1d<SweeperTrait, Enabled>::evaluate_rhs_expl(const typename SweeperTrait::time_type& t,
      ...
      template<class SweeperTrait, typename Enabled>
      shared_ptr<typename SweeperTrait::encap_type>
      QmOsc1d<SweeperTrait, Enabled>::evaluate_rhs_impl(const typename SweeperTrait::time_type& t,
                                                       const shared_ptr<typename SweeperTrait::encap_type> u)
      {
      ...
      template<class SweeperTrait, typename Enabled>
      void
      QmOsc1d<SweeperTrait, Enabled>::implicit_solve(shared_ptr<typename SweeperTrait::encap_type> f,
